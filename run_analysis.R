...
# Instruction 2: Extract only the measurements on the mean and standard deviation
...
# Instruction 5: Create a second, independent tidy set with the average of each variable for each activity and each subject
